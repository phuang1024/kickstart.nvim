    ...
    config = function()
      require('dashboard').setup {
        ...
        config = {
          ...
          center = {
            { icon = '', icon_hl = 'Title', desc = '  new', action = 'enew', key = 'n' },
            { icon = '', icon_hl = 'Title', desc = '  plugins', action = 'Lazy', key = 'p' },
            { icon = '󰌠', icon_hl = 'Title', desc = '  lsp', action = 'Mason', key = 'l' },
            { icon = '󰗼', icon_hl = 'Title', desc = '  quit', action = 'q', key = 'q' },
          },
          footer = {
            '', '', '', '', '',
            os.date('%A, %B %d'):lower(),
...
vim.keymap.set('n', '\\', '<cmd>ToggleTerm direction=vertical size=80<CR>')
